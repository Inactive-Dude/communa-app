...
### 1.1 ✅ [RESOLVED] Admin Portal Crash: `auth.js` Kicks Out Authenticated Admins
- **Files Affected:**
...
### 1.2 ✅ [RESOLVED] Stored Cross-Site Scripting (XSS) in Announcements & Events Feeds
- **Files Affected:**
...
### 1.3 ✅ [RESOLVED] Hardcoded CORS Allowed Origins in `SecurityConfig.java`
...
### 2.1 ✅ [RESOLVED] Hardcoded `http://localhost:8082` API URLs Across Frontend Pages
- **Files Affected:**
...
### 2.2 ✅ [RESOLVED] Missing `@Transactional` Annotations in Service Layer
...
### 2.3 ✅ [RESOLVED] Race Condition in Password Reset Cooldown Check
...
### 2.4 ✅ [RESOLVED] Lack of Club Authorization Scoping on Admin Endpoints
- **Files Affected:**
...
### 2.5 ✅ [RESOLVED] Insecure Password Reset Token Generation Strategy
...
### 2.6 ✅ [RESOLVED] Synchronous Email Dispatch Blocks Client HTTP Threads
